...
- Project `.opencode/workflow-guard.json[c]` may configure `protectedBranches`, `verifyCommand`, `requireReview`, `requireSubagentReview`, and `requireDocumentation`; behavior changes must honor these in addition to environment overrides/defaults.
